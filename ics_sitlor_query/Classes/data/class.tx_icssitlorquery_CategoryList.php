...
class tx_icssitlorquery_CategoryList extends tx_icssitlorquery_AbstractList {
	 ...
	 *
	 * @param	tx_icssitlorquery_Category $element : The element to add
	 * @return void
	 */
	 ...
	 *
	 * @param	tx_icssitlorquery_Category $element : The element to remove
	 * @return void
	 */
	 ...
	 *
	 * @param	int $position
	 * @param	tx_icssitlorquery_Category $element
	 * @return	void
	 */
